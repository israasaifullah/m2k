...
function App() {
  ...
  return (
    <main className="h-screen flex flex-col bg-[var(--geist-background)] text-[var(--geist-foreground)]">
      <header className="px-3 md:px-4 py-2 md:py-3 border-b border-[var(--geist-accents-2)] flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
        <h1 className="text-lg font-semibold">M2K</h1>
        <div className="flex items-center gap-2 md:gap-4 flex-wrap">
          <EpicFilter />
          <button
            onClick={selectFolder}
            className="px-2 md:px-3 py-1 md:py-1.5 text-xs md:text-sm border border-[var(--geist-accents-3)] rounded-md hover:bg-[var(--geist-accents-1)] transition-colors whitespace-nowrap"
          >
            Change Folder
          </button>
        </div>
